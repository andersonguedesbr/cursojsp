...
<form action="CadastrarUsuarioServlet" method="post">
	<ul class="form-style-1">
		...
		<li> <label> Login: <span class="required">*</span></label>
			 <input type="text" id="login" name="login" class="field-divided" placeholder="Insira o login">
			
		<li>
		
		<li> <label> Senha:  <span class="required">*</span></label>
			 <input type="password" id="senha" name="senha" class="field-divided" placeholder="Insira a senha">
